gettrainingdonesvm <- function(mytable3, classid, sampleid, ruleout, psd, metadat,svmmethod){
  ...
  RF_state_classify <- caret::train(as.factor(country)~. , data =train,method = "svmLinear")
